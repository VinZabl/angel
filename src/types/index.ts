...
export interface Order {
  id: string;
  invoice_number?: string | null; // Invoice number in format AGC1M{day}D{orderNumber} (e.g., AGC1M17D1)
...
export interface CreateOrderData {
  ...
  member_id?: string;
  order_option?: 'order_via_messenger' | 'place_order';
  invoice_number?: string; // Invoice number in format AGC1M{day}D{orderNumber}
}
